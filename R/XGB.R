...
model_xgb_sp
cvpreds_id <- model_xgb_sp@model$cross_validation_holdout_predictions_frame_id$name
...
model_xgb_temp <- h2o.xgboost(x = features,
                              ...
                              fold_column = "month")
model_xgb_temp
cvpreds_id <- model_xgb_temp@model$cross_validation_holdout_predictions_frame_id$name
