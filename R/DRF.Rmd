...
file_shared <- read_excel(here("data", "Final_Delhi_2019_Data.xlsx"), sheet = 1) %>%
  select("CWV" = CWVDailyMean_2019, "ELV" = Elevation_2019, 
         "AOD" = Corrected_DailyMeanAOD_2019, "PM2.5" = Corrected_PM25DailyMean_2019, "Station_code" = StationCode_2019, "Season" = Season_2019,
         ...
         "Press" = PressureDailyMean_2019, "day" = JulianDay_2019) %>%
